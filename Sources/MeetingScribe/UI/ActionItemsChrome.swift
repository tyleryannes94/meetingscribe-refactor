...
extension ActionItemsView {
    ...
    // Note: the inline Brain Dump capture that used to sit here was removed —
    // Brain Dump is now a first-class page in the Tasks sidebar, so duplicating a
    // capture box on the dashboard just added clutter.
